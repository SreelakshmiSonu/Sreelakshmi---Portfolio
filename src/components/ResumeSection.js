...
const LandingSection = () => {
  ...
  onSubmit: (values) => {
    submit(values); // Calls the useSubmit hook
  },
});
  ...
  return (
    ...
    >
      <VStack w="1024px" p={32} alignItems="flex-start">
        ...
        <Box w="100%" h="900px" borderRadius="md" overflow="hidden">
          <iframe
            src="/Sreelakshmi - Frontend Developer - CV.pdf"
            width="100%"
            height="100%"
            title="Sree CV"
          />
        ...
        <Button
          as="a"
          href="/Sreelakshmi - Frontend Developer - CV.pdf"
          download
          mt={4}
          colorScheme="purple"
        >
            ...
            <VStack spacing={4}>
              ...
              <FormControl isInvalid={formik.touched.type && formik.errors.type}>
                ...
                <Select
                  id="type"
                  name="type"
                  value={formik.values.type}      // <-- use Formik value
